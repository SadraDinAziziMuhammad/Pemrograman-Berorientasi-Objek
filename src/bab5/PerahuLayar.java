 ...
 * @author sadra
 */
public class PerahuLayar extends KendaraanLaut{ PerahuLayar(String nama, float kecepatan, float kapasitasTangki, float dayaAngkutBarang, float dayaAnkutManusia, int tahunKeluar, String warna){ 
...
System.out.println("\n============================PERA HU LAYAR============================");
System.out.println("\nPerahu layar ini bermerk " + this.nama + ", saya beli tahun " + this.tahunKeluar + " berwarna " + this.warna);
